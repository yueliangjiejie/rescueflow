...
const PORT = 3000;
let _paths=[]; app._router.stack.forEach(r=>{ if(r.route){_paths.push(r.route.path);} }); console.log("最后5个路由:", _paths.slice(-5)); console.log("总:", _paths.length); app.listen(PORT, () => {
  console.log(`\n========================================`);
